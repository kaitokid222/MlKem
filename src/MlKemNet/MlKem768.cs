...
/// <summary>
/// Provides the public ML-KEM-768 operation stubs defined by FIPS 203,
/// Sections 7.1 through 7.3, Algorithms 19 through 21.
/// </summary>
public sealed class MlKem768 : IKem
{
    /// <summary>
    /// Generates an ML-KEM-768 key pair as specified by FIPS 203,
    ...
    /// <summary>
    /// Encapsulates with ML-KEM-768 as specified by FIPS 203, Section 7.2,
    /// Algorithm 20.
    /// </summary>
    ...
    /// <summary>
    /// Decapsulates with ML-KEM-768 as specified by FIPS 203, Section 7.3,
    /// Algorithm 21.
    /// </summary>
